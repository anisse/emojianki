...
[Emoji Anki](https://anisse.github.io/emojianki/) lets you generate [Anki](https://en.wikipedia.org/wiki/Anki) decks containing just emojis, as well as their description in 150+ languages. You can use it with your native language to learn flags, or emoji names. Or use it with another language to learn the vocabulary associated with emoji objects, animals & nature, etc.
...
The website is fully static, with the code doing the parsing and Anki generation running from the browser. It's hosted on Github from this repository.
